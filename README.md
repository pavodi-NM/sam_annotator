...
[![Installs](https://img.shields.io/pypi/dt/sam-annotator?label=Installs&color=orange)](https://pypi.org/project/sam-annotator/ "Total number of installations via pip from PyPi")
